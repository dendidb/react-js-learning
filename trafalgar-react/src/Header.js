      ...
      <div className="container">
        <div className="header__nav">
          ...
          <ul className="header__nav__menu">
            ...
            <li className="header__nav__item">
              <a className="header__nav__link" href="#find-a-doctor">
                Find a doctor
              </a>
            </li>
            <li className="header__nav__item">
              <a className="header__nav__link" href="#apps">
                Apps
              </a>
            </li>
            <li className="header__nav__item">
              <a className="header__nav__link" href="#testimonials">
                Testimonials
              </a>
            </li>
            <li className="header__nav__item">
              <a className="header__nav__link" href="#about-us">
                About us
              </a>
            </li>
          </ul>
